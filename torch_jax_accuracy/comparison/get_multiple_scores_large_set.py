...
strong_llms_folder = '../large_set_exp/gpt-4o-manually/samples_100/'
...
# Output to TXT
text_path = 'large_codebleu_comparison_with_avg.txt'
...
excel_path = 'large_codebleu_comparison_with_avg.xlsx'
